...
const PLANS = [
  {
    ...
    features: ["1,000 credits/month", "3 agents", "Future-1 Mini & Future-1 Fast", "Community support"],
  ...
  },
  {
    ...
    features: ["50,000 credits/month", "Unlimited agents", "All Future models (Pro, Code, Mini, Fast)", "API access", "Priority support", "Team collaboration (up to 5)"],
    cta: "Start Pro",
    highlight: true,
  },
  {
    ...
    features: ["250,000 credits/month", "Unlimited agents", "All models including Future-1 Ultra", "Advanced API access", "Dedicated support", "Unlimited team members", "Custom integrations"],
    cta: "Start Business",
    highlight: false,
  },
];
