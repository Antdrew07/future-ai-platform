      ...
      <div className="p-6">
        ...
        {isLoading ? (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button variant="ghost" size="icon" className="w-7 h-7 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            <div className="w-20 h-20 rounded-2xl glass flex items-center justify-center mb-6 ring-1 ring-primary/20">
