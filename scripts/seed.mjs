...
const models = [
  {
    ...
    isActive: true,
    description: "Future's most powerful autonomous model. Browses the web, executes code, manages files, and completes complex multi-step tasks end-to-end.",
    maxTokens: 32768,
    supportsTools: true,
    supportsVision: true,
  },
  {
    ...
    isActive: true,
    description: "Future's flagship multimodal model. Excellent for complex reasoning, vision, and deep analysis.",
    maxTokens: 128000,
    supportsTools: true,
    supportsVision: true,
  },
  {
    ...
    isActive: true,
    description: "Fast and affordable Future model. Great for simple tasks and high-volume use cases.",
    maxTokens: 128000,
    supportsTools: true,
    supportsVision: true,
  },
  {
    ...
    creditsPerToolCall: 0.3,
    isActive: true,
    description: "Future's most intelligent coding model. Exceptional at software engineering, analysis, and nuanced reasoning.",
    maxTokens: 200000,
    supportsTools: true,
    supportsVision: true,
  },
  {
    ...
    creditsPerToolCall: 0.05,
    isActive: true,
    description: "Future's fastest and most compact model. Ideal for quick responses and simple tasks.",
    maxTokens: 200000,
    supportsTools: true,
    supportsVision: true,
  },
