...
- [x] Add live visual preview panel in AgentWorkspace right pane (images render inline as generated)
- [x] Show generated images as full-size previews in the execution log step cards
- [x] Show HTML/website previews in an iframe when agent builds a site
- [x] Show code with syntax highlighting inline in step cards
...
- [x] Fix agent to write complete books (all chapters, not just intro + 1 chapter) when given a transcript or topic
- [x] Fix agent to output books as PDF (via export_document), not raw .md files
- [x] Add book-writing specific instructions to system prompt: chapter-by-chapter planning, full content, professional formatting

## Book Writing & Preview Fix (Apr 18, 2026)
- [x] Fix agent system prompt: write complete books (all chapters) when given transcript/topic, not just intro + 1 chapter
- [x] Fix agent system prompt: output books as PDF via export_document, not raw .md files
- [x] Add Markdown book preview to Output Files panel (render .md files as formatted readable text)
- [x] Add PDF preview to Output Files panel (show PDF inline in preview pane)
